...
<div
  class={cn(
    'relative h-20 w-20 items-center justify-center rounded-md bg-yellow-100 text-4xl text-black shadow-md transition-transform dark:bg-yellow-200 dark:shadow-slate-700',
    className,
